...
function createTourCard(tour) {
    ...
    colDiv.innerHTML = `
        <article class="event-default-wrap" data-tour="${tour._id}" onclick="viewTour(this.dataset.tour)" style="cursor: pointer;">
...
function viewTour(tourIdentifier) {
    // tourIdentifier comes from the data-tour attribute, which is the tour._id
